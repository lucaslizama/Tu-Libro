<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ModificarPerfil.aspx.cs" Inherits="TuLibroWeb.MiPerfil" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contenidoCentro" runat="server">
        ...
        <br />        
            <asp:Table ID="table1" runat="server" BorderColor="Black" BorderWidth="3" Width="680px">
                <asp:TableRow>
                    <asp:TableCell>
                    ...
                    </asp:TableCell></asp:TableRow></asp:Table></asp:Content><asp:Content ID="Content4" ContentPlaceHolderID="contenidoBarraDerecha" runat="server">
</asp:Content>
